 ...
 *
 *【备注】：
 *[1]、如果只想使用getPageRange函数，可以直接注释或者删除掉showSamplePageView函数，
 *因为showSamplePageView函数的页面变现能力有限，用户可以根据自己的情况来定义css样式；
 *[2]、没有使用外部js库，可以直接使用，其中的__$(__id)函数是自己封装了，如果使用了JQuery的
 *同学，可以自行替换为JQuery自带的函数，但是要注意使用到了__$()函数的地方相应的方法也应该替换。
 *
